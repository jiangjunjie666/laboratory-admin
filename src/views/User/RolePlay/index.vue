  ...
  <div>
    <el-card>
      ...
      <div class="btn-list">
        ...
        <el-button type="primary" class="search" @click="getRoleList" :disabled="searchKey == ''">
          <el-icon>
            <Search />
          </el-icon>
          <span>查询</span>
    ...
    <el-card class=" table-card">
      <el-table :data="tableData" @selection-change="handleSelectionChange" v-loading="loading" style="width: 100%"
        ...
        <el-table-column property="name" label="用户名" width="200" align="center" />
        <el-table-column property="role_name" label="职位名称" width="200" align="center" />
...
<script setup>
import { reqGetUserList, reqDeleteAdmin } from '@/api/role.js'
...
function handlerTableData(data) {
  ...
  data.forEach(i => {
    const tableObj = {
      ...
      addressRole: i.authority ? i.authority.split(',') : []
    }
    arr.push(tableObj)
  });
  return arr;
